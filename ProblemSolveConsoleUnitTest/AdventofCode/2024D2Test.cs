...
1 3 6 7 9");
        ...
        {
            var result = _2024D2.GetSafeReportsWithDampener(@"7 6 4 2 1
1 2 7 8 9
9 7 6 2 1
1 3 2 4 5
8 6 4 4 1
1 3 6 7 9");
        ...
        {
            var result = _2024D2.GetSafeReportsWithDampener(@"86 85 86 89 92 94 97");
            Assert.Equal(1, result);
        }
        [Fact]
        public void GetSafeReportsWithDampenerTestIgnoreFirstNormal()
        {
            var result = _2024D2.GetSafeReportsWithDampener(@"86 82 81 80");
            Assert.Equal(1, result);
        }
        [Fact]
        public void GetSafeReportsWithDampenerTestTemp()
        {
            var result = _2024D2.GetSafeReportsWithDampener(@"51 52 55 58 60 61 62 61
64 65 67 70 72 74 77 77");
        ...
        {
            var result = _2024D2.GetSafeReportsWithDampener2(@"86 85 86 89 92 94 97");
            Assert.Equal(1, result);
        }
    }
}
